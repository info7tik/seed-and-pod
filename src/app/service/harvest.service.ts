...
export class HarvestService {
  ...
  getHarvests(): Harvest[] {
    return this.sortHarvests(this.yearService.getItemByYear(this.HARVESTS_KEY, []).map((h: HarvestWithStringDate) => ({ ...h, date: new Date(h.date) })));
  }
  ...
  private saveHarvests(harvests: Harvest[]): void {
    ...
    this.yearService.setItemByYear(this.HARVESTS_KEY, serializedHarvests);
  }
